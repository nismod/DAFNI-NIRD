...
if __name__ == "__main__":
    ...
    try:
        depth_key, event_key, num_of_cpu = sys.argv[1:]
        main(int(depth_key), int(event_key), int(num_of_cpu))
    except (IndexError, ValueError):
        logging.info("Please provide inputs: depth_key, event_key, and num_of_cpu!")
        sys.exit(1)
