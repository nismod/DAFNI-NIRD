...
joined_ppp = joined.merge(
    cluster_pop_ppp[["cluster_id", "cluster_ppp_2030", "cluster_ppp_2050"]],
    on="cluster_id",
    how="left",
)
...
joined_hhh = joined.merge(
    cluster_pop_hhh[["cluster_id", "cluster_hhh_2030", "cluster_hhh_2050"]],
    on="cluster_id",
    how="left",
)
