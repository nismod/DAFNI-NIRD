...
local_path = Path(
    r"C:\Oxford\Research\DAFNI\local\papers\final\revision\recovery_rates"
)
base_path = Path(r"P:\mistral\DAFNI_NIRD\results\rerouting_analysis\revision")

# %%
scenario_design = pd.read_csv(local_path / "recovery design_updated.csv")
slow_rates = pd.read_csv(local_path / "slow_rates.csv")
fast_rates = pd.read_csv(local_path / "fast_rates.csv")
ave_rates = pd.read_csv(local_path / "ave_rates.csv")
